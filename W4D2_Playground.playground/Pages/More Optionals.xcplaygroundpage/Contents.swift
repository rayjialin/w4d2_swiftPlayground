...
var newData = testData.filter { $0 != nil}
print(newData)
...
// This function checks if the number u to it is a positive or negative value
...
func validateUserInfo(username: String?, password: String?, email: String?){
...
validateUserInfo(username: "ray", password: "123456", email: "ray@.com")
//: [Next](@next)
