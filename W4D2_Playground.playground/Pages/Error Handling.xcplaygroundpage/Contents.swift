...
//func validateFields(name: String?, password: String?, email: String?) throws -> String{
//    if name == nil {
//        throw errorMessage.NameIsEmpty
//    }
//    if password == nil{
//        throw errorMessage.PasswordIsEmpty
//    }
//
//    if email == nil{
//        throw errorMessage.EmailIsEmpty
//    }
//
//    return "asdf"
//}
//
//validateFields(name: "aksdjf", password: "ksfj", email: "ksdjak")
...
class HondaDealership{
    ...
    func sellCar(model: String, offeredPrice: Int) throws {
        ...
        guard let _ = availableCarSupply[model] else { throw CarError.ModelDoesntExist}
        ...
        print("car of model: \(model) sold for: $\(offeredPrice)")
    }
...
do{
    try dealership.sellCar(model: "Civic", offeredPrice: 6600)
}
catch let error {
    print("error: \(error)")
}
