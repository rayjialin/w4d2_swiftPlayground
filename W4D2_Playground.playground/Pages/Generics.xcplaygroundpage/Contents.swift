 ...
 */
struct GroceryQueue<T>{
    var customers = [T]()
    mutating func enqueue(_ customer: T){
...
var customerArray = GroceryQueue<String>()
customerArray.enqueue("customer1")
print(customerArray)
customerArray.enqueue("customer3")
print(customerArray)
customerArray.dequeue()
print(customerArray)
